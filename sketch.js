...
function setup(){
  createCanvas(displayWidth,displayHeight);
   ...
   plastic =createSprite(random(200,700),displayHeight-75);
   plastic.addImage(pimg);
  
   kWaste= createSprite(random(200,700), displayHeight-75);
  ...
  //bg = createSprite(200, 200);
   ...
   green1 = createSprite(displayWidth-85, displayHeight-75);
   green1.addImage("green1",greenImg)
   green1.scale = 0.4
  
   blue = createSprite(displayWidth-285, displayHeight-75);
   blue.addImage("blue",blueImg)
   blue.scale = 0.4
  
   wpaper = createSprite(random(200,700), displayHeight-75, 1, 1);
   wpaper.addImage("np",npImg)
   wpaper.scale = 0.125
  
   sand = createSprite(random(200,700), displayHeight-75);
   sand.addImage("s",sImg)
   sand.scale = 0.15
  
   banana = createSprite(random(200,700), displayHeight-75);
   banana.addImage("b",bImg)
   banana.scale = 0.15
  
   apple = createSprite(random(200,700), displayHeight-75); 
